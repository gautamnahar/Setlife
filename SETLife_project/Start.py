...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # QtCore.QTimer.singleShot(1500, lambda: self.setStyleSheet("background-color: #000; color: #FFF"))
...
class SplashScreen(QMainWindow):
    def __init__(self):
        ...
        # Initial Text
        self.ui.label_description.setText("<strong>Welcome</strong> TO SetLife")
